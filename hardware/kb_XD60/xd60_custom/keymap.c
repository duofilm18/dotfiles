...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_FN] = LAYOUT_all(
        ...
        KC_TRNS, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MPLY, KC_UP,   KC_PSCR, KC_DEL,
        KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, KC_NO,   KC_TRNS,
        KC_TRNS, KC_NO,   KC_BTN1, KC_BTN2, KC_BTN3, KC_TRNS, KC_TRNS, KC_TRNS, KC_END,  KC_PGDN, KC_DOWN, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    [L_RGB] = LAYOUT_all(
        ...
        KC_CAPS, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, KC_ESC,  KC_P7,   KC_P8,   KC_P9,   KC_PPLS, KC_PMNS, KC_PAST, KC_TRNS,
        KC_TRNS, RGB_VAD, RGB_VAI, KC_TRNS, BL_TOGG, BL_STEP, KC_PENT, KC_P4,   KC_P5,   KC_P6,   KC_SCLN, KC_PPLS, KC_NO,   KC_TRNS,
