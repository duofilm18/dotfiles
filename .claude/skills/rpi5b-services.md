...
| Pi-hole | systemd (native) | 53, 80 | `ansible/roles/rpi_pihole/`，pihole-FTL service |
...
```bash
cd ~/dotfiles/ansible
ansible-playbook rpi5b.yml --tags pihole     # Pi-hole（原生）
ansible-playbook rpi5b.yml --tags docker     # ntfy / Uptime Kuma
